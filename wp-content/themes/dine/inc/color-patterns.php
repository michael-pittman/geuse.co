 ...
 */
function dine_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Dine default saturation level.
	 *
	 * @since Dine 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'dine_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.dine-front-page) .entry-title,
...
.colors-custom .dine-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.dine-front-page .panel-content .recent-posts article,
...
.colors-custom.dine-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Dine custom colors CSS.
	 *
	 * @since Dine 1.0
	 *
	 ...
	 */
	return apply_filters( 'dine_custom_colors_css', $css, $hue, $saturation );
}
